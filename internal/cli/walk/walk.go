...
// (`<img src>`, `<a href>`), which READMEs commonly use for centred logos.
//
...
// on-disk path. Markdown images and links plus raw-HTML `<img src>`/`<a href>`
// all count as references. External refs are left untouched; refs whose
